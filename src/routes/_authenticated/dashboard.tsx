    ...
    <>
      ...
      <div className="rounded-2xl border bg-card p-4 md:p-6">
        <div className="flex flex-col gap-2 sm:flex-row">
          <Input value={url} onChange={(e) => setUrl(e.target.value)} placeholder="https://www.walmart.com/ip/..." className="h-12 rounded-xl text-base" inputMode="url" />
        ...
        <p className="mt-2 text-xs text-muted-foreground">Only walmart.com URLs are supported. Tracking parameters are stripped automatically.</p>
      </div>
    </>
  );
}